...
public class FullAmtFragment extends BaseMvpFragment<CouponPresenter> implements ICouponView {
    ...
    public static FullAmtFragment getInstance(String couponId) {
        FullAmtFragment fullAmtFragment = new FullAmtFragment();
    ...
    public int getLayout() {
        return R.layout.fragment_fullamt_coupon;
    }
