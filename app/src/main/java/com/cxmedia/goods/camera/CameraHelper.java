package com.cxmedia.goods.camera;
...
//            Log.e("camera", Camera.getNumberOfCameras()+" " + specificCameraId +" " + specificCameraId);
//
...
//                    previewSize = getBestSupportedSize(supportedPreviewSizes, previewViewSize);
                    previewSize = getOptimalPreviewSize(supportedPreviewSizes, previewDisplayView.getWidth(), previewDisplayView.getHeight());
                }
